...
const PaymentInvoice = (props) => {
  const { cartData, setCartData, userData, setUserData, value, setValue } =
    props;
            ...
            <div style={{ flex: "1" }}>
              <div>
                ...
                <div>
                  ...
                  <span style={{ fontSize: "12px" }}>
                    {userData != null ? userData.result.name : "no user data"}
                  </span>
                </div>
                <div>
                  <span style={{ fontSize: "14px" }}>Email : </span>
                  <span style={{ fontSize: "12px" }}>
                    {userData != null ? userData.result.email : "no user data"}
                  </span>
                </div>
              </div>
            </div>
